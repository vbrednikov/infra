...
echo '--------- Install ruby -------------'
sudo -u "appuser" bash -c 'gpg --keyserver hkp://keys.gnupg.net --recv-keys 409B6B1796C275462A1703113804BB82D39DC0E3 && \
...
sudo -u "appuser" bash -c 'pushd ~ && . ~/.rvm/scripts/rvm && \
    git clone https://github.com/Artemmkin/reddit.git && \
    pushd reddit && bundle install && puma -d'
